    ...
    public class JwtSettings
    {
        ...
        public void ValidateSettings()
        {
            if (string.IsNullOrWhiteSpace(SecretKey))
                throw new InvalidOperationException("SecretKey is missing or empty");
            ...
            if (string.IsNullOrWhiteSpace(Issuer))
                throw new InvalidOperationException("Issuer is missing or empty");

            if (string.IsNullOrWhiteSpace(Audience))
                throw new InvalidOperationException("Audience is missing or empty");
