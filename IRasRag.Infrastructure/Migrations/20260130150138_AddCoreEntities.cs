        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    farm_id = table.Column<Guid>(type: "uuid", nullable: false),
                    topic_code = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    camera_url = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    is_deleted = table.Column<bool>(type: "boolean", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    modified_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    deleted_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    estimated_harvest_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    actual_harvest_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    command_on = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    command_off = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    execution_days = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    is_deleted = table.Column<bool>(type: "boolean", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    modified_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    deleted_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    trigger_condition = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    modified_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    deleted_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<Guid>(type: "uuid", nullable: false),
                    action_taken = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "farms",
                columns: new[] { "id", "address", "created_at", "deleted_at", "email", "is_deleted", "modified_at", "name", "phone_number" },
                values: new object[] { new Guid("aaaaaaaa-0000-0000-0000-000000000001"), "Đường 123, Tp.HCM", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "contact@aquabluefarm.vn", false, null, "Trang trại RAS mẫu", "+84-123-456-789" });

            migrationBuilder.InsertData(
                table: "feed_types",
                columns: new[] { "id", "created_at", "deleted_at", "description", "manufacturer", "modified_at", "name", "protein_percentage", "weight_per_unit" },
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-0000-0000-0000-000000000201"), null, null, "Thức ăn có hàm lượng protein cao, phù hợp cho giai đoạn đầu phát triển của cá.", "AquaFeed Solutions", null, "Giàu protein", 45f, 25f },
                    { new Guid("aaaaaaaa-0000-0000-0000-000000000202"), null, null, "Thức ăn tiêu chuẩn, phù hợp cho giai đoạn phát triển tiếp theo của cá.", "AquaFeed Solutions", null, "Tiêu chuẩn", 38f, 25f }
                });

            migrationBuilder.InsertData(
                table: "growth_stages",
                columns: new[] { "id", "created_at", "deleted_at", "description", "modified_at", "name" },
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-0000-0000-0000-000000000401"), null, null, "Giai đoạn từ khi nở đến khi cá phát triển đủ lớn để chuyển sang giai đoạn cá giống.", null, "Cá bột" },
                    { new Guid("aaaaaaaa-0000-0000-0000-000000000402"), null, null, "Giai đoạn từ cá bột đến khi cá đạt kích thước thương phẩm.", null, "Cá giống" }
                });

            migrationBuilder.InsertData(
                table: "sensor_types",
                columns: new[] { "id", "created_at", "deleted_at", "measure_type", "modified_at", "name", "unit_of_measure" },
                values: new object[,]
                {
                    { new Guid("eeeeeeee-0000-0000-0000-000000000001"), null, null, "Nhiệt độ", null, "Nhiệt độ nước", "Độ C" },
                    { new Guid("eeeeeeee-0000-0000-0000-000000000002"), null, null, "Tính axit", null, "Độ pH", "pH" }
                });

            migrationBuilder.InsertData(
                table: "species",
                columns: new[] { "id", "created_at", "deleted_at", "modified_at", "name" },
                values: new object[] { new Guid("aaaaaaaa-0000-0000-0000-000000000101"), null, null, null, "Cá rô phi" });

            migrationBuilder.InsertData(
                table: "users",
                columns: new[] { "id", "created_at", "deleted_at", "email", "first_name", "is_deleted", "is_verified", "last_name", "modified_at", "password_hash", "role_id", "user_name" },
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-0000-0000-0000-000000000001"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "admin@example.com", "", false, true, "", null, "$2a$11$TjsTmXlpjjTVPajZiLxCV.XPuTPgCgphg7sfC9Fs/YwSA4M4IYqYu", new Guid("aaaaaaaa-0000-0000-0000-000000000001"), "admin" },
                    { new Guid("aaaaaaaa-0000-0000-0000-000000000002"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "user@example.com", "", false, true, "", null, "$2a$11$TjsTmXlpjjTVPajZiLxCV.XPuTPgCgphg7sfC9Fs/YwSA4M4IYqYu", new Guid("aaaaaaaa-0000-0000-0000-000000000002"), "user" }
                });

            migrationBuilder.InsertData(
                table: "fish_tanks",
                columns: new[] { "id", "camera_url", "created_at", "deleted_at", "farm_id", "height", "is_deleted", "modified_at", "name", "radius", "topic_code" },
                values: new object[] { new Guid("aaaaaaaa-0000-0000-0000-000000000301"), "", null, null, new Guid("aaaaaaaa-0000-0000-0000-000000000001"), 0f, false, null, "Bể nuôi số 1", 0f, "tank/001" });

            migrationBuilder.InsertData(
                table: "species_stage_configs",
                columns: new[] { "id", "amount_per100fish", "created_at", "deleted_at", "expected_duration_days", "feed_type_id", "frequency_per_day", "growth_stage_id", "max_stocking_density", "modified_at", "species_id" },
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-0000-0000-0000-000000000601"), 0.5f, null, null, 30, new Guid("aaaaaaaa-0000-0000-0000-000000000201"), 6, new Guid("aaaaaaaa-0000-0000-0000-000000000401"), 50f, null, new Guid("aaaaaaaa-0000-0000-0000-000000000101") },
                    { new Guid("aaaaaaaa-0000-0000-0000-000000000602"), 3f, null, null, 90, new Guid("aaaaaaaa-0000-0000-0000-000000000202"), 3, new Guid("aaaaaaaa-0000-0000-0000-000000000402"), 30f, null, new Guid("aaaaaaaa-0000-0000-0000-000000000101") }
                });

            migrationBuilder.InsertData(
                table: "user_farms",
                columns: new[] { "id", "created_at", "deleted_at", "farm_id", "modified_at", "user_id" },
                values: new object[] { new Guid("44444444-0001-0001-0001-000000000001"), null, null, new Guid("aaaaaaaa-0000-0000-0000-000000000001"), null, new Guid("aaaaaaaa-0000-0000-0000-000000000002") });
