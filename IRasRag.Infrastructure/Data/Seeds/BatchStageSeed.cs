        ...
        public static List<BatchStage> BatchStages =>
            [
                ...
                new BatchStage
                {
                    ...
                    SpeciesStageConfigId = SpeciesStageConfigSeed.FryStageConfigId,
                    Sequence = 1,
                    EstimatedStartDate = new DateTime(2023, 12, 01, 0, 0, 0, DateTimeKind.Utc),
                    EstimatedEndDate = new DateTime(2023, 12, 31, 0, 0, 0, DateTimeKind.Utc),
                    ExpectedDurationDays = 30,
                    ActualStartDate = new DateTime(2023, 12, 01, 0, 0, 0, DateTimeKind.Utc),
                    ActualEndDate = new DateTime(2023, 12, 30, 0, 0, 0, DateTimeKind.Utc),
                    CreatedAt = SeedTimestamp,
                    ModifiedAt = SeedTimestamp,
                },
            ];
