...
{
    public class ActiveFarmingBatchDtoListSpec : Specification<FarmingBatch, ActiveFarmingBatchResponseDto>
    {
        public ActiveFarmingBatchDtoListSpec(Guid fishTankId)
        {
            Query.AsNoTracking()
                ...
                .Select(fb => new ActiveFarmingBatchResponseDto
                {
                    ...
                    TankVolume = Math.Round(Math.PI * fb.FishTank.Height * fb.FishTank.Height * fb.FishTank.Radius, 2)
                });
        }
    }
}
