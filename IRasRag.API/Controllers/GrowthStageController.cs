...
namespace IRasRag.API.Controllers
{
    ...
    public class GrowthStageController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAllGrowthStages([FromQuery] int page = 1, [FromQuery] int pageSize = 10)
        {
            try
            {
                ...
                var result = await _growthStageService.GetAllGrowthStagesAsync(page, pageSize);
                return Ok(result);
            }
            catch (Exception ex)
            {
