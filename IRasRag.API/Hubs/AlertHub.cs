...
namespace IRasRag.API.Hubs
{
    ...
    public class AlertHub : Hub
    {
        ...
        public AlertHub(IUserTankAccessService tankAccess)
        {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            // Join per-tank alert groups so server can push targeted alerts
        ...
        /// <summary>Subscribe to alerts for a specific tank.</summary>
        ...
        public static string TankGroup(string tankId) => $"alert-tank-{tankId}";
